...
! function() {
	"use strict";
	var e = window.CgsLayui && CgsLayui.define,
		t = {
			getPath: function() {
		...
		n = {
			...
			ready: function(a) {
				...
				return e ? CgsLayui.addcss(o, a, i) : t.link(o, a, i), this
			}
		},
		a = function() {
			var e = this;
		...
		d = [100, 2e5],
		c = "CgsLayui-laydate-static",
		m = "CgsLayui-laydate-list",
		u = "laydate-selected",
		h = "CgsLayui-laydate-hint",
		y = "laydate-day-prev",
		f = "laydate-day-next",
		p = "CgsLayui-laydate-footer",
	...
	C.prototype = [], C.prototype.constructor = C, w.extend = function() {
		...
		}), e.elemID = "CgsLayui-laydate" + t.elem.attr("lay-key"), (t.show || a) && e.render(), a || e.events(), t.value && t.isInitValue && (t.value.constructor === Date ? e.setValue(e.parse(0, e.systemDate(t.value))) : e.setValue(t.value)))
		...
		var e = this,
			...
			i = e.elem = w.elem("div", {
				id: e.elemID,
				"class": ["CgsLayui-laydate", t.range ? " CgsLayui-laydate-range" : "", a ? " " + c : "", t.theme && "default" !== t.theme && !/^#/.test(t.theme) ? " laydate-theme-" + t.theme : ""].join("")
			}),
			r = e.elemMain = [],
			o = e.elemHeader = [],
			s = e.elemCont = [],
		...
		if(t.zIndex && (i.style.zIndex = t.zIndex), w.each(new Array(2), function(e) {
				...
				var a = w.elem("div", {
						"class": "CgsLayui-laydate-header"
					}),
					i = [function() {
						var e = w.elem("i", {
							"class": "CgsLayui-icon laydate-icon laydate-prev-y"
						});
						return e.innerHTML = "&#xe65a;", e
					}(), function() {
						var e = w.elem("i", {
							"class": "CgsLayui-icon laydate-icon laydate-prev-m"
						});
						return e.innerHTML = "&#xe603;", e
					}(), function() {
						var e = w.elem("div", {
						...
						var e = w.elem("i", {
							"class": "CgsLayui-icon laydate-icon laydate-next-m"
						});
						return e.innerHTML = "&#xe602;", e
					}(), function() {
						var e = w.elem("i", {
							"class": "CgsLayui-icon laydate-icon laydate-next-y"
						});
						return e.innerHTML = "&#xe65b;", e
					}()],
					d = w.elem("div", {
						"class": "CgsLayui-laydate-content"
					}),
					c = w.elem("table"),
					m = w.elem("thead"),
					u = w.elem("tr");
				w.each(i, function(e, t) {
					...
					"class": "CgsLayui-laydate-main laydate-main-list-" + e
			...
			var m = w.elem("style"),
				u = ["#{{id}} .CgsLayui-laydate-header{background-color:{{theme}};}", "#{{id}} .CgsLayui-this{background-color:{{theme}} !important;}"].join("").replace(/{{id}}/g, e.elemID).replace(/{{theme}}/g, t.theme);
	...
	}, window.lay = window.lay || w, e ? (n.ready(), CgsLayui.define(function(e) {
		n.path = CgsLayui.cache.dir, e(i, n)
